package com.vehicleManagement.vehicleInfo.Security;

import com.google.common.base.Strings;
import com.vehicleManagement.vehicleInfo.ServiceImpl.UserServiceImpl;
...
public class JwtFilter extends OncePerRequestFilter {
    ...
    @Autowired
    private UserServiceImpl userServieceImpl;
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        try {
            ...
            if (StringUtils.hasText(token) && jwtUtil.validateToken(token, "secret")) {
                ...
                UserDetails userDetails = userServieceImpl.loadByUserName(userName);
